...
+
** Accedere al sito di assistenza NetApp ( https://mysupport.netapp.com/products/index.html["https://mysupport.netapp.com/products/index.html"^]).
...
** Scarica il file del plug-in SnapCenter per VMware vSphere `.tar` in qualsiasi posizione.
