...
| 1 | Consultare `\http://<vCenter-IP>/mob` | Individuare il moref delle macchine virtuali dall'URL VMware Managed Objects. Notare il *moref* della macchina virtuale in cui si trova il VMDK. 
...
vmdklocations` | `Get Vmdk Locations` Ottiene un elenco di VMDK per la VM specificata. Annotare le informazioni *vmdkLocationsList*. 
